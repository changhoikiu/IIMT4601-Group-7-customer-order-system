...
export default function BookInfo(props) {
  ...
  return (
    <Flex
      ...
      {...getOverrideProps(overrides, "BookInfo")}
      {...rest}
    >
      <Image
        width="294px"
      ...
      >
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Title29766828")}
        >
          <Flex
            gap="8px"
            direction="row"
          ...
          >
            <Text
              ...
              {...getOverrideProps(overrides, "${Author}/${Creator}")}
            ></Text>
            <View
              width="24px"
              height="24px"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Title36532689")}
          >
            <Text
              fontFamily="Inter"
              fontSize="24px"
              ...
              whiteSpace="pre-wrap"
              children="${Book_Title}"
              {...getOverrideProps(overrides, "${Book_Title}")}
            ></Text>
            <Badge
              width="unset"
              height="unset"
        ...
        >
          <Text
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children="Publisher: ${Publisher} ISBN: ${ISBN}"
            {...getOverrideProps(
              overrides,
          ...
          <Text
            ...
            {...getOverrideProps(overrides, "Description: ${Description}")}
          ></Text>
        </View>
        <Flex
          gap="27px"
        ...
        >
          <Text
            ...
            whiteSpace="pre-wrap"
            children="$99 HKD"
            {...getOverrideProps(overrides, "$99 HKD")}
          ></Text>
          <Button
            width="127px"
            height="unset"
